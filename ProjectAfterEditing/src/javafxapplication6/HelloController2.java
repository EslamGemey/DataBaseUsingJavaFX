...
public class HelloController2 implements Initializable{
    ...
    protected void onButtonClick(ActionEvent event) {
      ...
      String input = id.getText();           
		...
		{ 
			...
			JOptionPane.showMessageDialog(null, "Please Enter string in name field");
		}  
		catch (NumberFormatException e)  
		{ 
			//JOptionPane.showMessageDialog(null, "Please Enter number in id field"); 
         ...
         if(id.getText().isEmpty()){
            ...
            JOptionPane.showMessageDialog(null, "Please enter ID must be contain numbers");
            ...
            JOptionPane.showMessageDialog(null, "Please enter Your phone must be contain numbers");
        }
        else if(jop.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Please enter Your job title");
        }
        else if(isInt == true){
            JOptionPane.showMessageDialog(null, "Please enter string in name field");
        }
    ...
    protected void onUpdateClick(ActionEvent aEvent){
        ...
        String sqlS1="SELECT * FROM emp_info WHERE emp_id='"+id.getText()+"' ";
        boolean databaseupdated = false;
        try {
            ps=con.prepareStatement(sqlS1);
            res=ps.executeQuery(sqlS1);
            
            if(res.next()){
                databaseupdated = true;
            }
            /*while (res.next()) {
               if(res.getString(1) == id.getText()){
                   databaseupdated = true;
                   break;
        ...
        if(databaseupdated){
            ...
            JOptionPane.showMessageDialog(null, e.getMessage());
             ...
             JOptionPane.showMessageDialog(null, "This id is not found in database");
        }
